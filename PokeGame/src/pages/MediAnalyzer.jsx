...
function AnalyzerPage() {
  ...
  return (
    <>
      <CSSwrapper className="analyzer" />
      <PokeballThrow />
      <NavBar />
      <main>
        <div className="assistant">
          <h1>Medical Analyzer</h1>
          <AmyLupin message="Click to go to Main Menu, this page is not quite finished" route="/welcome"/>
        </div>
        <section className="mediAnalyzer">
          <div className="user">
            <div className="medical">
              <span className="medical-header"><strong>Status Condition Analysis</strong></span>
            </div>
          </div>
        </section>
        <>
